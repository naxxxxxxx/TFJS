...
var vals = /*#__PURE__*/Object.freeze({
  isNumber: isNumber$1,
  isInt: isInt$1,
  isString: isString$1,
  ...
  validateTypesMatch: validateTypesMatch,
  validateFunctionArgs: validateFunctionArgs,
  extractValidator: extractValidator
});
...
var bridge = require('dsbridge');

var hasNativeMethod = bridge.hasNativeMethod;
var Bridge = function Bridge() {
  _classCallCheck(this, Bridge);

  _defineProperty(this, "send", function (name, params) {
  ...
  _defineProperty(this, "registerAsync", function (name, callback) {
  ...
  _defineProperty(this, "methodBuilder", function () {
    ...
    if (_this.bridge !== null && _this.from !== 'js') {
      return function (callback) {
        if (callback && _this.mode !== 'async') {
          return _this.bridge.register(_this.call, callback);
        } else if (callback && _this.mode === 'async') {
          _this.bridge.registerAsync(_this.call, callback);
        }
...
function () {
  function TF() {
    ...
    _defineProperty(this, "hasNativeMethod", function (name, mode) {
      // mode:["all"|"syn"|"asyn" ]
      if (!isString$1(name)) {
